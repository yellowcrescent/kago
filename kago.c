...
void* kago_fovr_get(char *funcname TSRMLS_DC) {
    for(int i = 0; i < KAGO_G(func_overrides_len); i++) {
        fprintf(stderr, "kago_fovr_get(): strcmp(funcname @@ 0x%08x, KAGO_G(func_overrides)[%d].funcname @@ 0x%08x)\n", funcname, i, KAGO_G(func_overrides)[i].funcname);
        fprintf(stderr, "kago_fovr_get(): funcname @@ 0x%08x = '%s'\n", funcname, funcname);
        fprintf(stderr, "kago_fovr_get(): KAGO_G(func_overrides)[%d].funcname @@ 0x%08x = '%s'\n", i, KAGO_G(func_overrides)[i].funcname, KAGO_G(func_overrides)[i].funcname);
